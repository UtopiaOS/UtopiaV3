...
static struct {
    ...
    { C_EALREADY, S("Connection is already in progress") },
    ...
    { C_ENOTTY, S("Inappropiate I/O control operation") },
    ...
    { C_EOWNERDEAD, S("Previous owned died") },
