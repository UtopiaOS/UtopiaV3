...
pushd "$DIR/Tarballs/$GCC_NAME"
    ...
    buildstep gcc/stageTwo/patch/0044 patch -Np0 -i "$DIR/Patches/gnu/gcc/0044-linux_decisions.patch"
    buildstep gcc/stageTwo/patch/0045 patch -Np0 -i "$DIR/Patches/gnu/gcc/0045-config.gcc-linux-common-and-utopia.patch"
    buildstep gcc/stageTwo/patch/0046 patch -Np0 -i "$DIR/Patches/gnu/gcc/0046-add_mt_utopia.patch"
    buildstep gcc/stageTwo/patch/0047 patch -Np0 -i "$DIR/Patches/gnu/gcc/0047-configure_support_utopia.patch"
    buildstep gcc/stageTwo/patch/0048 patch -Np0 -i "$DIR/Patches/gnu/gcc/0048-configure_ac_support_utopia.patch"
    buildstep gcc/stageTwo/patch/0049 patch -Np0 -i "$DIR/Patches/gnu/gcc/0049-config-sub-utopia.patch"
    buildstep gcc/stageTwo/patch/0050 patch -Np0 -i "$DIR/Patches/gnu/gcc/0050-utopia-basic-definition.patch"
    buildstep gcc/stageTwo/patch/0051 patch -Np0 -i "$DIR/Patches/gnu/gcc/0051-utopia-driver.patch"
    buildstep gcc/stageTwo/patch/0052 patch -Np0 -i "$DIR/Patches/gnu/gcc/0052-linux-common-use-linux-decisions.patch"
...
pushd "$DIR/Build/gccTwo"
    ...
    make AS_FOR_TARGET="${UTOPIA_TARGET}-as" \
        LD_FOR_TARGET="${UTOPIA_TARGET}-ld"
