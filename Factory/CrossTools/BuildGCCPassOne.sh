...
pushd "$SOURCES_DIR/$GCC_NAME"
    if [ ! -f ".support_patch" ]; then
        ...
        patch -Np1 -i "$DIR/Patches/gnu/gcc/0045-config.gcc-linux-common-and-utopia.patch"
        ...
        patch -Np1 -i "$DIR/Patches/gnu/gcc/0049-config-sub-utopia.patch"
        patch -Np1 -i "$DIR/Patches/gnu/gcc/0050-utopia-basic-definition.patch"
        ...
        patch -Np1 -i "$DIR/Patches/gnu/gcc/0058-fix_includes_on_libsystem.patch"
        patch -Np1 -i "$DIR/Patches/gnu/gcc/0059-tm_defines_libsystem.patch"
        patch -Np1 -i "$DIR/Patches/gnu/gcc/0060-stdint_corrections.patch"
        patch -Np1 -i "$DIR/Patches/gnu/gcc/0061-linux_define_libsystem_basic.patch"
        patch -Np1 -i "$DIR/Patches/gnu/gcc/0062-linux_common_choose_linker.patch"
        patch -Np1 -i "$DIR/Patches/gnu/gcc/0063-libsystem_option.patch"
        patch -Np1 -i "$DIR/Patches/gnu/gcc/0064-linker_paths.patch"
        touch .support_patch
    else
