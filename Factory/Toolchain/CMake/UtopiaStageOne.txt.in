set(CMAKE_SYSTEM_NAME UtopiaOS)
set(CMAKE_SYSTEM_PROCESSOR "@UTOPIA_ARCH@")
...
configure_file("@UTOPIA_SOURCE_DIR@/Meta/Tools/ld-wrapper.sh.in" "${CMAKE_BINARY_DIR}/ld-wrapper.sh" USE_SOURCE_PERMISSIONS @ONLY)
...
set(CMAKE_C_FLAGS "-ffreestanding -nostdlib -target x86_64-trip-linux-macho -U__APPLE__ -D__UTOPIA__=1" CACHE INTERNAL "")
set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS}" CACHE INTERNAL "")
set(CMAKE_ASM_FLAGS "-nostdlib -target x86_64-trip-linux-macho" CACHE INTERNAL "")
